          ...
          <div className="footerDiv">
            ...
            <div>
              <div className='logosdiv'>
                <a href='https://atlasv.io/' target="_blank" rel="noopener noreferrer"><img className='logos' src="/atlasV.png" alt='' /></a>
                <a href='https://www.nfb.ca/interactive/marrow' target="_blank" rel="noopener noreferrer"><img className='logos' src="/NFB.png" alt='' /></a>
                <a href='https://ars.electronica.art/news/de/' target="_blank" rel="noopener noreferrer"><img className='logos' src="/Ars-Electronica.png" alt='' /></a>
                <a  href='https://www.starts.eu/' target="_blank" rel="noopener noreferrer"><img className='logos startLogo' src="/start.png" alt='' /></a>
                <a href='https://ec.europa.eu/programmes/horizon2020/en/home' target="_blank" rel="noopener noreferrer"><img className='logos' src="/enLogo.png" alt='' /></a>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ...
            using the dataset of <a className='link footer' href="https://github.com/NVlabs/ffhq-dataset/" alt="" target="_blank" rel="noopener noreferrer"> Flickr-Faces-HQ Dataset</a>. 
            Same dataset was used at <a className='link footer' href="https://thispersondoesnotexist.com/" alt="" target="_blank" rel="noopener noreferrer"> 'This Person Does Not Exist' project. </a>
            The latent space explorer tool invites you to encode your own images to the latent space, and create chains of key-frame animations between different points on GAN's latent space in a collaborative way.
            <br />
            <br />
